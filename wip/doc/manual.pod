...
I<deposit-name> I<establishment-date> I<maturity-date> I<term> I<interest> I<amount>
...
Failure because of an HTTP error. This may be due to a network error, but might as well be a result of an scraping error (see below).

=item Z<>3

Failure because of an unexpected behaviour of the web interface (so called “scraping error”).
If you encounter this, please file a bug at the L<issue tracker|https://code.google.com/p/mbank‐cli/issues/list>.
