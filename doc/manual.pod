...
Consult the B<FILES> section for the configuration file syntax.

=item B<--cookie-jar> I<cookie-jar-file>

Use I<cookie-jar-file> as the session cookie storage file.

Consult the B<FILES> section for details.
...
=head2 Session cookie storage file (a.k.a. cookie jar)
...
Please report bugs at the L<issue tracker|https://code.google.com/p/mbank-cli/issues>.
