...
=item *
B<mbank-cli> B<history> [I<option>...] [B<--from> I<start-date> [B<--to> I<end-date>] ] [B<--export> I<format>] {I<account> | B<-M> I<account>...  | B<-A>}
...
Please report bugs at the L<issue tracker|https://bitbucket.org/jwilk/mbank-cli/issues>.
