...
=item *
B<mbank-cli> B<history2019> [I<option>...] [B<--from> I<start-date> [B<--to> I<end-date>] ] [B<--with-id>] [B<--export> I<format>] {I<account> | B<-M> I<account>...  | B<-A>}
...
=head2 The “history2019” command

Syntax:
B<mbank-cli> B<history2019> [I<option>...] [B<--from> I<start-date> [B<--to> I<end-date>] ] [B<--with-id>] [B<--export> I<format>] {I<account> | B<-M> I<account>...  | B<-A>}

This is an experimental variant of the “history” command
that uses new API introduced in 2019.

Print the history of the selected account(s),
in the following format:

I<[account-name]> I<[id]> I<type> I<date> I<amount> I<balance> I<description> I<[comment]>
