...
mbank-cli - (legacy) command-line interface to the on-line banking system of mBank
...
This is the legacy version of B<mbank-cli>, which uses the web interface at
L<https://www.mbank.com.pl/>, which is in the process of being shut down.
...
Show operations with the date between I<start-date> and I<end-date>, inclusive.
...
Failure because of an unexpected behaviour of the web interface (so called “API error”). If you encounter this, please file a bug at the L<issue tracker|https://code.google.com/p/mbank‐cli/issues>.
...
=head1 EXAMPLES
    ...
    $ ./mbank-cli list  # list accounts

    $ ./mbank-cli history eKonto  # print history of the “eKonto” account

    $ ./mbank-cli history eKonto --range 2005-01-01 2005-12-31

    $ ./mbank-cli history eKonto --from 2006-06-01

    $ ./mbank-cli future eMax  # print planned operations for the “eMax” account

    $ ./mbank-cli rename 'eMax - foo' 'bar'  # from now on, it will be called “eMax - bar”

    $ ./mbank-cli funds  # list investment funds
